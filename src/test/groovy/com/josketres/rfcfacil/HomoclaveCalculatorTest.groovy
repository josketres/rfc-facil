...
class HomoclaveCalculatorTest {

    @Test
    void should_calculate_homoclave_for_simple_test_case() {

        assertThat homoclave("Juan", "Perez", "Garcia"), equalTo("LN")
    }

    @Test
    void should_calculate_same_homoclave_for_names_with_and_without_accents() {
    ...
    @Test
    void should_calculate_homoclave_for_person_with_more_than_one_name() {

        assertThat homoclave("Jose Antonio", "Del real", "Anzures"), equalTo("N9")
    }

    @Test
    void should_calculate_homoclave_for_name_with_n_with_tilde() {

        assertThat homoclave("Juan", "Muñoz", "Ortega"), equalTo("T6")
    }

    @Test
    void should_calculate_homoclave_for_name_with_multiple_n_with_tilde() {

        assertThat homoclave("Juan", "Muñoz", "Muñoz"), equalTo("RZ")
    }

    @Test
    void should_calculate_different_homoclave_for_name_with_n_with_tilde_and_without() {
    ...
    @Test
    void should_calculate_homoclave_for_name_with_u_with_umlaut() {

        assertThat homoclave("Jesus", "Argüelles", "Ortega"), equalTo("JF")
    }

    @Test
    void should_calculate_same_homoclave_for_name_with_u_with_umlaut_and_without() {
    ...
    @Test
    void should_calculate_homoclave_for_name_with_ampersand() {

        assertThat homoclave("Juan", "Perez&Gomez", "Garcia"), equalTo("2R")
    }

    @Test
    void should_calculate_same_homoclave_for_name_with_and_without_special_characters() {
    ...
    @Test
    void should_calculate_different_homoclave_for_names_with_and_without_ampersand() {
    ...
    @Test
    void should_calculate_same_homoclave_for_different_birthdays() {
